...
export function Schedule() {
  return (
    ...
    >
      ...
      <div className="grain relative isolate mb-12 border-2 border-stamp/70 p-6 md:p-8">
      ...
      {/* Weekly grid */}
      <ol className="grid gap-px border-2 border-bone/20 bg-bone/20 sm:grid-cols-2 lg:grid-cols-5">
